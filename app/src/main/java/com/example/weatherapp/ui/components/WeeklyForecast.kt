...
import com.example.weatherapp.model.data.ForecastData
import com.example.weatherapp.model.data.ForecastItem
...
private fun Forecast(
    ...
    val secondaryTextColor = remember(item.isSelected) {
        return@remember if (item.isSelected) ColorTextSecondaryVariant else ColorTextPrimaryVariant
    }
